...
function dtimes_me(d) {
	...
	if (g == 1 || g == 4 || g == 6) {
		...
		document.write((now.getDate()) + " " + months_localized['es'][now.getMonth()]);
	} else if (g == 2 || g == 5 || g == 7) {
		var now = new Date();
...
function dtime_me(d) {
	var now = new Date();
	now.setDate(now.getDate() + d + 1);
	document.write(days_localized['es'][now.getDay()] + " " + (now.getDate()) + ", " + " " + months_localized['es'][now.getMonth()] + " " + (now.getFullYear()));
}

function dtime_month(d) {
	var now = new Date();
	now.setDate(now.getDate() + d + 1);
	document.write(months_localized['es'][now.getMonth()]);
}
